...
for filename in files:
    ...
    boxes = detect_people_on_image(img)
    ...
    for (x1, y1, x2, y2, conf) in boxes:
        ...
        cv.rectangle(boxed, (x1, y1), (x2, y2), (0, 0, 0), 15)

        cv.putText(boxed,f"person {conf:.2f}",(x1, max(20, y1 - 10)),cv.FONT_HERSHEY_SIMPLEX,5,(255, 0, 0),5)

    cv.putText(boxed,f"People count: {people_count}",(20, 110),cv.FONT_HERSHEY_SIMPLEX,5,(0, 0, 255),5)
...
print("Поріг впевненності:", CONF_THRESHOLD)
